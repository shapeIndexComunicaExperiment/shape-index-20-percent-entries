# Shape Index Solidbench Experiment with Comunica where 20% of the shape index entries are closed shapes 

Experiments to benchmark solidbench queries using the shape index approach, where 50% of the datasets expose a shape index.
